...
public class SubformFinderServiceImpl implements SubformFinderService {
    ...
    public Form getForm( String ctxUID ) {
        try {
            ...
            if ( editorContext != null ) {
                return getFormByPath( editorContext.getPath() );
            }
    ...
    public Form getFormById( long formId,
        ...
        try {
            FormEditorContext editorContext = formEditorContextManager.getRootEditorContext( ctxUID );
            if ( editorContext != null ) {
                return getFormById( formId, editorContext );
            }
    ...
    public Form getSubFormFromPath( String formPath,
        ...
        try {
            ...
            FormEditorContext editorContext = formEditorContextManager.getRootEditorContext( ctxUID );
            if ( editorContext != null ) {
                return getSubForm( formPath, editorContext );
            }
    ...
    protected Form getFormById( long formId,
                                FormEditorContext editorContext ) throws Exception {
