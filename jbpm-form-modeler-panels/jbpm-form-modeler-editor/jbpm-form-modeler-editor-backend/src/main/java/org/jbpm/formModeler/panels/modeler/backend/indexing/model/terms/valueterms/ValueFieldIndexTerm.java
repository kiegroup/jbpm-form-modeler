...
import org.jbpm.formModeler.panels.modeler.backend.indexing.model.terms.FieldIndexTerm;
...
public class ValueFieldIndexTerm extends FieldIndexTerm implements ValueIndexTerm {
    ...
    public ValueFieldIndexTerm(final String fieldName) {
        this.fieldName = PortablePreconditions.checkNotNull("fieldName", fieldName);
    }
