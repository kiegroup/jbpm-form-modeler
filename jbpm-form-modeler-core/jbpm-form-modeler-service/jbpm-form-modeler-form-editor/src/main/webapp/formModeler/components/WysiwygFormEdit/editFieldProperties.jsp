            ...
            <tr>
                <td align="left" colspan="3">
                    <div class="headerEditFP">
                        <input type="image" onclick="$('#<factory:encode name="actionToDo"/>').val('<%=WysiwygFormEditor.ACTION_CANCEL_FIELD_EDITION%>');this.onclick=function(){return false;}" style="cursor:hand; float: left; margin-right: 15px;" src="<static:image relativePath="actions/close.png"/>"><i18n:message key="properties">Properties</i18n:message> (<%=fieldName%>)
                    </div>
                </td>
            </tr>
            <tr>
