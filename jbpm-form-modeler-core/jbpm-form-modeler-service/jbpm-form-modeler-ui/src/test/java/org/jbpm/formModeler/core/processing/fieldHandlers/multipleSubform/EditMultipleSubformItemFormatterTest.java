...
public class EditMultipleSubformItemFormatterTest extends DefaultFieldHandlerFormatterTest<EditMultipleSubformItemFormatter> {
    ...
    @Override
    protected EditMultipleSubformItemFormatter getFormatterInstance() {
        EditMultipleSubformItemFormatter formatter = new EditMultipleSubformItemFormatter();
