...
public class ShortDateFieldHandlerFormatterWithDefaultValueTest extends AbstractDateFieldHandlerFormatterTest<ShortDateFieldHandler> {
    ...
    @Override
    protected ShortDateFieldHandler getHandler() {
        return new ShortDateFieldHandler();
    }
    ...
    protected Field getMockedField() {
        ...
        currentField.setFieldType(fieldTypeManager.getTypeByCode("InputShortDate"));
