...
public class NumericFieldHandler extends DefaultFieldHandler {
    ...
    public String[] getCompatibleClassNames() {
        return new String[]{String.class.getName(), Short.class.getName(), Integer.class.getName(), Long.class.getName(), Float.class.getName(), Double.class.getName()};
    }
