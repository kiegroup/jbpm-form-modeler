...
@Named("PreviewMultipleSubformItemFormatter")
public class PreviewMultipleSubformItemFormatter extends AbstractMultipleSubformItemFormatter {

    @Override
    protected Integer getItemPosition( String namespace ) {
        return helper.getPreviewFieldPosition( namespace );
    }
    ...
    protected Form getForm(Field field, String currentNamespace) {
        ...
        return fieldHandler.getPreviewDataForm(field, currentNamespace);
    }
}
