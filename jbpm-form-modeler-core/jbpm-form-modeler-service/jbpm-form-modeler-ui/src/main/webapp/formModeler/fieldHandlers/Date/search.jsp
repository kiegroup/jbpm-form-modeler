...
%>
                onclick="document.getElementById('<%=uid + DateFieldHandler.HAS_CHANGED_PARAM%>').value = true;
                        NewCal('<mvc:fragmentValue name="uid"/><%=DateFieldHandler.DATE_FROM_SUFFIX%>','<%=calendarPattern%>',true);
                        return false; "
<%
    } else{
%>
...
%>
        ...
        <td>
            <a href="#"
               onclick="document.getElementById('<mvc:fragmentValue name="uid"/><%=DateFieldHandler.DATE_FROM_SUFFIX%>').value='';
...
%>
                onclick="document.getElementById('<%=uid + DateFieldHandler.HAS_CHANGED_PARAM%>').value = true;
                        NewCal('<mvc:fragmentValue name="uid"/><%=DateFieldHandler.DATE_TO_SUFFIX%>','<%=calendarPattern%>',true);
                        return false; "
<%
    } else{
%>
...
%>
        ...
        <td>
             <a href="#"
                onclick="document.getElementById('<mvc:fragmentValue name="uid"/><%=DateFieldHandler.DATE_TO_SUFFIX%>').value='';
                     document.getElementById('<%=uid + DateFieldHandler.HAS_CHANGED_PARAM%>').value = true;
                     return false;">
                <img src="<static:image relativePath="general/16x16/ico-trash.png"/>" border="0">
            </a>
