...
<mvc:formatter name="RadioGroupFieldHandlerFormatter">
    <mvc:formatterParam name="<%=RadioGroupFieldHandlerFormatter.PARAM_MODE%>" value="<%=RadioGroupFieldHandlerFormatter.MODE_SHOW%>"/>
    <mvc:fragment name="output">
        <div><mvc:fragmentValue name="value"/></div>
    </mvc:fragment>
</mvc:formatter>