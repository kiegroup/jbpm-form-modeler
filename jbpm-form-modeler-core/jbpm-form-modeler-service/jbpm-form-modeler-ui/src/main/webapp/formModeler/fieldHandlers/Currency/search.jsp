    ...
    <mvc:fragment name="output">
        ...
        <td>
                                                        <input  name="<%=name%><%=NumericFieldHandler.NUMERIC_FROM_SUFFIX%>"  id="<mvc:fragmentValue name="uid"/><%=NumericFieldHandler.NUMERIC_FROM_SUFFIX%>"
                                                            ...
                                                            <%=disabled!=null && ((Boolean)disabled).booleanValue()? " disabled ":""%>
                                                                value="<%=StringEscapeUtils.escapeHtml(StringUtils.defaultString(value!=null? (value instanceof Object[]? (((Object[])value)[0]!=null?String.valueOf(((Object[])value)[0]):""):String.valueOf(value)):""))%>">
        </td>                                           &nbsp;<b>&#8364;</b>
        <td>
                                                        &nbsp;-&nbsp;
        </td>
        <td>
                                                        <input  name="<%=name%><%=NumericFieldHandler.NUMERIC_TO_SUFFIX%>"  id="<mvc:fragmentValue name="uid"/><%=NumericFieldHandler.NUMERIC_TO_SUFFIX%>"
                                                            ...
                                                            <%=readonly!=null && ((Boolean)readonly).booleanValue()? " readonly ":""%>
                                                            <%=disabled!=null && ((Boolean)disabled).booleanValue()? " disabled ":""%>
                                                                value="<%=StringEscapeUtils.escapeHtml(StringUtils.defaultString(value!=null? (value instanceof Object[]? (((Object[])value)[1]!=null?String.valueOf(((Object[])value)[1]):""):String.valueOf(value)):""))%>">
        </td>                                               &nbsp;<b>&#8364;</b>
                                                    </mvc:fragmentValue>
                                                </mvc:fragmentValue>
                                            </mvc:fragmentValue>
